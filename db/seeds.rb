...
chinParty = chinInt.gatherings.create!(topic: "Party", location: "Chinatown", date: "2/28/2017", photo_url: "https://lh4.googleusercontent.com/u66otdfjRqeMEOoQ554u5OwfA8FE5svWdf1f1J88n9QpU2qlpPwA5ed0mAGx-_Z6_yML8v1QnvGX3EjCeeJCFOOZCMJcT57x5uLGeoWEnsEbyWA_f30", description: "Party time friends welcome.", user_id: eva.id)
chinfood = chinBeg.gatherings.create!(topic: "Ordering food", location: "Chinatown", date: "3/4/2017", photo_url: "http://0.lushome.com/wp-content/uploads/2013/01/chinese-new-year-celebration-table-decorations-meals.jpg", description: "Lets take a trip to chinese restaurant", user_id: eva.id)
